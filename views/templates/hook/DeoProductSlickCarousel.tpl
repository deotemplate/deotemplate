...
{else}
	{if !empty($products)}
		<div class="slick-row">
			<div class="slick-carousel deo-carousel slick-slider deo-carousel-loading {if isset($formAtts.slick_showloading) && $formAtts.slick_showloading}show-icon-loading{/if} {(isset($productClassWidget) && $productClassWidget) ? $productClassWidget : ''}" id="{$formAtts.form_id}" 
