...
<div class="owl-row">
	<div class="carousel-slider deo-carousel owl-carousel owl-theme deo-carousel-loading {if isset($formAtts.showloading) && $formAtts.showloading}show-icon-loading{/if} {(isset($productClassWidget) && $productClassWidget) ? $productClassWidget : ''}" id="{$formAtts.form_id}" 
