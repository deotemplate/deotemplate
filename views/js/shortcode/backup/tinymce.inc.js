...
function changeToMaterial() {
  var materialIconAssoc = {
	...
	'mce-i-deotemplate': '<i class="material-icons">settings_ethernet</i>',
...
function tinySetup(config) {
  ...
  var default_config = {
    selector: ".rte",
    plugins: "align deotemplate colorpicker link image filemanager table media placeholder advlist code table autoresize",
