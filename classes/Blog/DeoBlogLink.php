...
class DeoBlogLink extends Link
{
    ...
    public function getDeoblogLink($id_object, $controller, $params = array())
    {
     ...
     */
    public function getDeoPaginationLink($type, $id_object, $controller, $params, $nb = false, $sort = false, $pagination = false, $array = true)
    {
